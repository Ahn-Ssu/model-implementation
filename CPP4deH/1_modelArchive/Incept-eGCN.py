...
class EGCN(nn.Module):
    def __init__(self, args):
        ...
        self.conv12 = geonn.GATConv(self.input_dim, self.hidden_dim, negative_slope=0.1) # 실험 해보니까, 헤드를 32개로 쪼개면 안정적이고 성능이 상당히 잘 나옴
        ...
        self.conv22 = geonn.GATConv(self.hidden_dim, self.hidden_dim, negative_slope=0.1)
        self.conv32 = geonn.GATConv(self.hidden_dim, self.hidden_dim, negative_slope=0.1)
        # LE 
