...
class SAGE(nn.Module):
    def __init__(self, args):
        ...
        self.conv1 = geonn.SAGEConv(args.input_dim, self.hidden_dim, normalize=args.convNorm, aggr=args.convAggr)
        ...
        self.hidden_dim *= 2
        self.conv2 = geonn.SAGEConv(self.hidden_dim, self.hidden_dim, normalize=args.convNorm, aggr=args.convAggr)
        ...
        self.hidden_dim *= 2
        self.conv3 = geonn.SAGEConv(self.hidden_dim, self.hidden_dim, normalize=args.convNorm, aggr=args.convAggr)
        ...
        self.hidden_dim *= 2
        self.redconv1 = graphConv_1x1(self.hidden_dim, int(2*args.hidden_dim))
        self.hidden_dim = int(2*args.hidden_dim)
        self.conv4 = geonn.SAGEConv(self.hidden_dim, self.hidden_dim, normalize=args.convNorm, aggr=args.convAggr)
        ...
        self.hidden_dim *= 2
        self.conv5 = geonn.SAGEConv(self.hidden_dim, self.hidden_dim, normalize=args.convNorm, aggr=args.convAggr)
        ...
        self.hidden_dim *= 2
        self.conv6 = geonn.SAGEConv(self.hidden_dim, self.hidden_dim, normalize=args.convNorm, aggr=args.convAggr)
        ...
        # self.redconv2 = geonn.SAGEConv(self.hidden_dim, args.hidden_dim)
        # self.hidden_dim = args.hidden_dim

        self.hidden_dim *= 2
        self.conv7 = geonn.SAGEConv(self.hidden_dim, self.hidden_dim, normalize=args.convNorm, aggr=args.convAggr)
        ...
        # self.hidden_dim *= 2
        # self.conv8 = geonn.SAGEConv(self.hidden_dim, self.hidden_dim, normalize=args.convNorm)
        ...
        # self.hidden_dim *= 2
        # self.conv9 = geonn.SAGEConv(self.hidden_dim, self.hidden_dim, normalize=args.convNorm)
        # self.norm9 = geonn.BatchNorm(self.hidden_dim)
        # self.skip9 = SkipConnection(self.hidden_dim, self.hidden_dim, concat=args.skipConcat, compress=args.skipCompress)
    ...
    def forward(self, g):
        ...
        h3 = self.redconv1(h3, g.id_index)
        h3 = F.elu(h3)
